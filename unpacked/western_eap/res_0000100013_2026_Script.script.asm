...
fn @ 0x05b0  ; helper (call-target)
  ; varCount=2
    @0x05b1  SetLocalVar(0, Rand(IntConst(0), IntConst(1)))
    @0x05be  SetLocalVar(1, GetLocalVar(0))
    @0x05c2  Switch(GetLocalVar(1); 0=>0x5d6, 1=>0x5f7)
    @0x05d6  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(694), IntConst(423)), IntConst(1), 1604)
    @0x05f2  Goto(1560)
    @0x05f7  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(404), IntConst(258)), IntConst(1), 1604)
    @0x0613  Goto(1560)
    @0x0618  SetLocalVar(1, Add(GetLocalVar(1), IntConst(1)))
    @0x0622  IfNotEqual(GetLocalVar(1), IntConst(2), 1589)
    @0x062e  SetLocalVar(1, IntConst(0))
    @0x0635  IfNotEqual(GetLocalVar(1), GetLocalVar(0), 1474)
    @0x063e  Return(IntConst(0))
    @0x0644  Return(IntConst(1))
...
fn @ 0x064a  ; helper (call-target)
  ; varCount=2
    @0x064b  SetLocalVar(0, Rand(IntConst(0), IntConst(1)))
    @0x0658  SetLocalVar(1, GetLocalVar(0))
    @0x065c  Switch(GetLocalVar(1); 0=>0x670, 1=>0x691)
    @0x0670  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(22), IntConst(25)), IntConst(1), 1758)
    @0x068c  Goto(1714)
    @0x0691  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(404), IntConst(258)), IntConst(1), 1758)
    @0x06ad  Goto(1714)
    @0x06b2  SetLocalVar(1, Add(GetLocalVar(1), IntConst(1)))
    @0x06bc  IfNotEqual(GetLocalVar(1), IntConst(2), 1743)
    @0x06c8  SetLocalVar(1, IntConst(0))
    @0x06cf  IfNotEqual(GetLocalVar(1), GetLocalVar(0), 1628)
    @0x06d8  Return(IntConst(0))
    @0x06de  Return(IntConst(1))

fn @ 0x06e4  ; helper (call-target)
  ; varCount=2
    @0x06e5  SetLocalVar(0, Rand(IntConst(0), IntConst(1)))
    @0x06f2  SetLocalVar(1, GetLocalVar(0))
    @0x06f6  Switch(GetLocalVar(1); 0=>0x70a, 1=>0x72b)
    @0x070a  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(22), IntConst(25)), IntConst(1), 1912)
    @0x0726  Goto(1868)
    @0x072b  IfEqual(Call(fn@0x0, GetLocalVar(2), IntConst(694), IntConst(423)), IntConst(1), 1912)
    @0x0747  Goto(1868)
    @0x074c  SetLocalVar(1, Add(GetLocalVar(1), IntConst(1)))
    @0x0756  IfNotEqual(GetLocalVar(1), IntConst(2), 1897)
    @0x0762  SetLocalVar(1, IntConst(0))
    @0x0769  IfNotEqual(GetLocalVar(1), GetLocalVar(0), 1782)
    @0x0772  Return(IntConst(0))
    @0x0778  Return(IntConst(1))
