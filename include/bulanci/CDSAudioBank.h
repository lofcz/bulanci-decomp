...
public:
	...
	/* 406340 */ uchar CDSAudioBank_ResizeSlots(int param_1);
	// !DECL 0x00406340 END
	...
	/* 4293E0 */ uchar CDSAudioBank_dtor(uint* param_1);
	// !DECL 0x004293e0 END
	// !DECL 0x004294b0 BEGIN
	/* 4294B0 */ void* CDSAudioBank_ScalarDeletingDtor(uchar param_1);
	// !DECL 0x004294b0 END
	// !DECL 0x00429530 BEGIN
	/* 429530 */ void* CDSAudioBankSample_ctor(int* param_1, uint param_2, uchar* param_3);
	// !DECL 0x00429530 END
	// !DECL 0x00429600 BEGIN
	/* 429600 */ void CDSAudioBank_Deserialize(CDSFilterStream* param_1);
	// !DECL 0x00429600 END
