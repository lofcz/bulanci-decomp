...
public:
	...
	/* 423900 */ void CGunMouse_OnMouseMove(uint param_1, int* param_2);
	// !DECL 0x00423900 END
	// !DECL 0x00423ac0 BEGIN
	/* 423AC0 */ uchar CGunMouse_CoordRing_Clear(int param_1);
	// !DECL 0x00423ac0 END
	// !DECL 0x00423b50 BEGIN
	/* 423B50 */ uchar CGunMouse_Activate(void* param_1);
	// !DECL 0x00423b50 END
	...
	/* 4249B0 */ void CGunMouse_Erase(void* param_1);
	// !DECL 0x004249b0 END
	// !DECL 0x00425730 BEGIN
	/* 425730 */ void CGunMouse_dtor(void* param_1);
	// !DECL 0x00425730 END
