...
public:
	...
	/* 4188B0 */ static uchar CLevelScriptOpExt_ResortDepth(int param_1);
	// !DECL 0x004188b0 END
	// !DECL 0x004188e0 BEGIN
	/* 4188E0 */ static uchar CLevelScriptOpExt_TranslateTo(int param_1);
	// !DECL 0x004188e0 END
	...
	/* 418B20 */ static void* CLevelScriptOpExt_CollInsert(CDSScript* param_1);
	// !DECL 0x00418b20 END
	...
	/* 41A4A0 */ static uchar CLevelScriptOpExt_InsertView(int param_1);
	// !DECL 0x0041a4a0 END
	...
	/* 41BB30 */ static uint CLevelScriptOpExt_DefineDangerZone(CDSScript* param_1);
	// !DECL 0x0041bb30 END
	...
	/* 41D8F0 */ static uint CLevelScriptOpExt_LoadPreface(CDSScript* param_1);
	// !DECL 0x0041d8f0 END
	// !DECL 0x0041d990 BEGIN
	/* 41D990 */ static int CLevelScriptOpExt_SetViewImage(int param_1);
	// !DECL 0x0041d990 END
	// !DECL 0x0041da50 BEGIN
	/* 41DA50 */ static CMina* CLevelScriptOpExt_CreateMine(void* param_1);
	// !DECL 0x0041da50 END
	// !DECL 0x0041e3e0 BEGIN
	/* 41E3E0 */ static uint CLevelScriptOpExt_KillObject(CDSScript* param_1);
	// !DECL 0x0041e3e0 END
