...
public:
	...
	/* 43B270 */ uint* CDSDirectPlay_ctor(uint* param_1);
	// !DECL 0x0043b270 END
	// !DECL 0x0043b2d0 BEGIN
	/* 43B2D0 */ uchar* FUN_0043b2d0();
	// !DECL 0x0043b2d0 END
	// !DECL 0x0043b2e0 BEGIN
	/* 43B2E0 */ uchar CDSDirectPlay_dtor_body(uint* param_1);
	// !DECL 0x0043b2e0 END
	// !DECL 0x0043b600 BEGIN
	/* 43B600 */ uint* CDSDirectPlay_scalar_deleting_dtor(uchar param_1);
	// !DECL 0x0043b600 END
};
