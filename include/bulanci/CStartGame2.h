...
public:
	...
	/* 40D3F0 */ void CStartGame2_SelectPlayerByName(wchar_t* param_1);
	// !DECL 0x0040d3f0 END
	// !DECL 0x0040d520 BEGIN
	/* 40D520 */ void CStartGame2_UpdateDuplicateSerialWarning(void* param_1);
	// !DECL 0x0040d520 END
	// !DECL 0x0040d570 BEGIN
	/* 40D570 */ void CStartGame2_UpdateGamemodeCaption(uchar param_1);
	// !DECL 0x0040d570 END
	...
	/* 412E90 */ uchar CStartGame2_ApplySetAvatar(uchar param_1, uchar param_2, void* param_3);
	// !DECL 0x00412e90 END
	// !DECL 0x00412ed0 BEGIN
	/* 412ED0 */ uchar FUN_00412ed0(uchar param_1, int param_2, void* param_3);
	// !DECL 0x00412ed0 END
	// !DECL 0x00412f10 BEGIN
	/* 412F10 */ uchar CStartGame2_SetGameTypeAdminByte(uchar param_1, void* param_2);
	// !DECL 0x00412f10 END
	...
	/* 42D7A0 */ uchar CStartGame2_CompareLevelName(uint* param_1);
	// !DECL 0x0042d7a0 END
