...
public:
	...
	/* 401350 */ int* CBulanci_GetPathExtension(int* param_1);
	// !DECL 0x00401350 END
	...
	/* 402840 */ uint CBulanci_GetDataKindStubZero(int param_1);
	// !DECL 0x00402840 END
	// !DECL 0x00402850 BEGIN
	/* 402850 */ uchar CBulanci_DtorScalar_thunk_Sub4(uchar param_1);
	// !DECL 0x00402850 END
	// !DECL 0x00402860 BEGIN
	/* 402860 */ uchar CBulanci_DtorScalar_thunk_Sub10(uchar param_1);
	// !DECL 0x00402860 END
	// !DECL 0x00402870 BEGIN
	/* 402870 */ uchar CBulanci_DtorScalar_thunk_Sub18(uchar param_1);
	// !DECL 0x00402870 END
	// !DECL 0x00402880 BEGIN
	/* 402880 */ uchar* CBulanci_GetClassTable();
	// !DECL 0x00402880 END
	// !DECL 0x00402890 BEGIN
	/* 402890 */ uchar* CDSReferenced_GetTypeInfo_Base();
	// !DECL 0x00402890 END
	...
	/* 402DF0 */ uchar CBulanci_ChainDtorBody(int param_1);
	// !DECL 0x00402df0 END
	// !DECL 0x00402e00 BEGIN
	/* 402E00 */ uchar CBulanci_ReferencedDtorBody(int param_1);
	// !DECL 0x00402e00 END
	// !DECL 0x00402e10 BEGIN
	/* 402E10 */ uchar CBulanci_EventHandlerDtorBody(int param_1);
	// !DECL 0x00402e10 END
	// !DECL 0x004049c0 BEGIN
	/* 4049C0 */ uchar CDSChain_AdjustThisOffset_ThisMinus0xc(int param_1);
	// !DECL 0x004049c0 END
	...
	/* 429D00 */ void CDSApp_OnActivateApp(char param_1);
	// !DECL 0x00429d00 END
	...
	/* 42C370 */ void CDSView_LoadData(int param_1);
	// !DECL 0x0042c370 END
	...
	/* 42D7B0 */ int CDsString_FindLastWideChar(short param_1, int param_2);
	// !DECL 0x0042d7b0 END
	...
	/* 42E730 */ int CBulanci_PackedTimeToMs(int* param_1);
	// !DECL 0x0042e730 END
	// !DECL 0x0042e850 BEGIN
	/* 42E850 */ uchar CBulanci_PackTimeDwordFromSystemTime(int param_1);
	// !DECL 0x0042e850 END
	// !DECL 0x0042e880 BEGIN
	/* 42E880 */ uchar CBulanci_SetDateFromShortFields(ushort* param_1);
	// !DECL 0x0042e880 END
