...
public:
	...
	/* 422630 */ void StopPlayback(uchar param_1);
	// !DECL 0x00422630 END
	// !DECL 0x00422840 BEGIN
	/* 422840 */ uchar OnMovieStop(char param_1);
	// !DECL 0x00422840 END
	// !DECL 0x00422860 BEGIN
	/* 422860 */ void OnEvent(short param_1, void* param_2);
	// !DECL 0x00422860 END
	...
	/* 422E30 */ uint* CMovieView_CreateObject();
	// !DECL 0x00422e30 END
	...
	/* 4236A0 */ void CMovieView_Constructor(int param_1, int param_2, uint param_3, uint param_4, uint param_5);
	// !DECL 0x004236a0 END
	// !DECL 0x00423787 BEGIN
	/* 423787 */ uchar* Catch_00423787();
	// !DECL 0x00423787 END
	// !DECL 0x004237b0 BEGIN
	/* 4237B0 */ void CMovieView_InitTrackSequence();
	// !DECL 0x004237b0 END
};
