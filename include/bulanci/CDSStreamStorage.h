...
public:
	...
	/* 401860 */ uchar CDSStreamStorage_CloseStream(void* param_1);
	// !DECL 0x00401860 END
	...
	/* 4339D0 */ void* CDSStreamStorage_GetStreamEntry(int param_1);
	// !DECL 0x004339d0 END
	// !DECL 0x00433cb0 BEGIN
	/* 433CB0 */ void* CDSStreamStorage_CloseStreamByKey(void* param_1);
	// !DECL 0x00433cb0 END
	// !DECL 0x00433e60 BEGIN
	/* 433E60 */ void CDSStreamStorage_dtor(uchar param_1);
	// !DECL 0x00433e60 END
	// !DECL 0x00433f00 BEGIN
	/* 433F00 */ void* CDSStreamStorage_GetThreadLoaderNode();
	// !DECL 0x00433f00 END
	// !DECL 0x00433f70 BEGIN
	/* 433F70 */ void* CDSStreamStorage_AppendOrReuseStream(CDSStrmResInfo* param_1, void** param_2);
	// !DECL 0x00433f70 END
	...
	/* 434380 */ void CDSStreamStorage_AddRefHeldObject(void* param_1);
	// !DECL 0x00434380 END
	// !DECL 0x00434600 BEGIN
	/* 434600 */ uchar CDSChain_AdjustThisOffset_ThisMinus4(int param_1);
	// !DECL 0x00434600 END
	// !DECL 0x004346f0 BEGIN
	/* 4346F0 */ static void CDSResourceException_ThrowFromResourceId(uint param_1);
	// !DECL 0x004346f0 END
	// !DECL 0x00434760 BEGIN
	/* 434760 */ void* CDSStreamStorage_CreateFilterSafeStream(int* param_1, uint param_2, int param_3, uint param_4, int param_5, uint param_6);
	// !DECL 0x00434760 END
	...
	/* 401790 */ void* CDSStreamStorage_ctor(int* param_1);
	// !DECL 0x00401790 END
	// !DECL 0x00434160 BEGIN
	/* 434160 */ void CDSStreamStorage_InitRootSafeStream(int* param_1);
	// !DECL 0x00434160 END
};
