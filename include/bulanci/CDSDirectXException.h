...
public:
	...
	/* 43B720 */ static int CDSDirectXException_ResolveMessageStringId(int param_1, int param_2);
	// !DECL 0x0043b720 END
	...
	/* 43B820 */ void CDSDirectXException_ThrowFromHresult(uint param_1, uint param_2);
	// !DECL 0x0043b820 END
	// !DECL 0x0043b8b0 BEGIN
	/* 43B8B0 */ static uchar CDSDirectXException_AllocEmpty();
	// !DECL 0x0043b8b0 END
