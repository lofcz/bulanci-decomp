...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-accent/10 focus:text-foreground data-[state=open]:bg-accent/10",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, inset, destructive, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive && "text-rose-300 focus:bg-rose-500/10 focus:text-rose-200",
      inset && "pl-8",
      className,
    )}
    {...props}
...
export {
  ...
  ContextMenuSubContent, ContextMenuLabel, ContextMenuSeparator, ContextMenuShortcut,
};

// Suppress unused-import warnings for the `Check`/`Circle` icons; they
// stay imported because future shadcn upgrades land checkbox/radio
// variants of the menu items, and re-exporting the originals from this
// file keeps that addition a one-line edit.
void Check;
void Circle;
