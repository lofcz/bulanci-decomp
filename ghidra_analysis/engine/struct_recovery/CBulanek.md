...
| `+0x120` | 2 | `ushort` | `wField_120` | ctor `= 0` |
...
| `+0x128` | 4 | `uint` | `dwField_128` | ctor `= 0` |
| `+0x13C` | 4 | `uint` | `dwField_13C` | ctor `= 0` |
| `+0x140` | 4 | `int` | `nField_140` | ctor `= 100` |
| `+0x144` | 1 | `byte` | `bField_144` | ctor `= 0xff` |
...
| `+0x16C` | 4 | `uint` | `dwField_16C` | ctor zero band |
| `+0x178` | 16 | `pointer[4]` | `apAiTrackHolders` | ctor AI loop `FUN_0041b420` when `(byte)param_3 > 3` |
| `+0x188` | 4 | `uint` | `dwField_188` | ctor `= 0` |
| `+0x18C` | 4 | `int` | `nLivesRemaining` | ctor `param_7`; script `0xD7` decrement (`damage_pipeline.md`) |
| `+0x190` | 4 | `int` | `nField_190` | ctor duplicate of `param_7` @ offset 400 |
| `+0x194` | 4 | `int` | `nSpeedParam` | ctor clamp `[0x28,200]`; `TM_SetFrameDelayOverrideMs` when `!= 100` |
| `+0x198` | 1 | `byte` | `bField_198` | ctor `= 0` |
| `+0x199` | 1 | `byte` | `bIsAiVariant` | ctor `3 < (byte)param_3` |
| `+0x19A` | 1 | `byte` | `bField_19A` | ctor `= 0` |
...
- `dwField_A4`, `dwField_128`, `dwField_13C`, `nField_140`, `bField_144`, `dwField_16C`, `dwField_188`, `nField_190`, `bField_198`, `bField_19A`.
